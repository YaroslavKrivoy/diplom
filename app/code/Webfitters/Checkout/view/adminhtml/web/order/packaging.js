        ...
        sendCreateLabelRequest: function () {
            ...
            if (this.createLabelUrl) {
                ...
                this.packagesContent.childElements().each(function (pack) {
                    ...
                    price = parseFloat(pack.select('input[name="container_charge"]')[0].value);
                    packagesParams[packageId] = {
                        ...
                        container_charge:           isNaN(price) ? '' : price,
                ...
                for (var packageId in this.packages) {
                    if (!isNaN(packageId)) {
                        ...
                        this.paramsCreateLabelRequest['packages[' + packageId + ']' + '[params]' + '[container_charge]']       = packagesParams[packageId]['container_charge'];
