...
namespace Amasty\GiftCard\Plugin\View\Page\Config;
...
class Renderer
{
    const CACHE_KEY = 'amasty_giftcard_should_load_css_file';
    ...
    public function beforeRenderAssets(
        ...
        if ($shouldLoad) {
            $this->config->addPageAsset('Amasty_GiftCard::css/source/mkcss/amgiftcard.css');
        }
