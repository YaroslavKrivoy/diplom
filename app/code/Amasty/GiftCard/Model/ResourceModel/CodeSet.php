...
{
    const TABLE = 'amasty_amgiftcard_code_set';
    ...
    {
        $this->_init(self::TABLE, CodeSetInterface::CODE_SET_ID);
    }
    ...
    protected function _generateCodes($qty, $object)
    {
        ...
        $codeGenerator
            ...
            ->generateAndSave($qty,  array(CodeSetInterface::CODE_SET_ID => $object->getId()));
    }
    ...
    protected function _loadCodes($csvFile, $object)
    {
        ...
        $this->codeResource->massSaveCodes($listForSave, array(CodeSetInterface::CODE_SET_ID => $object->getId()));
