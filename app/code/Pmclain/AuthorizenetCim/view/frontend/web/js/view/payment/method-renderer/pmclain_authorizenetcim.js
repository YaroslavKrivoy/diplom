  ...
  function ($,
    ...
    return Component.extend({
      ...
      initialize: function() {
        ...
        /*$(document).on('click', '#pmclain_authorizenetcim', function(event){
          if($('#pmclain_authorizenetcim').get(0).checked == true && $('#billing-address-same-as-shipping-shared').get(0).checked == false){
            $('#billing-address-same-as-shipping-shared').get(0).checked = true;
          }
        });*/
        /*$(document).on('click', '[id^=pmclain_authorizenetcim_vault_]', function(event){
          $('#billing-address-same-as-shipping-shared').get(0).checked = true;
        });*/
      },
