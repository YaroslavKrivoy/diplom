...
abstract class Items extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $this->_setActiveMenu('Infomodus_Upslabel::items')->_addBreadcrumb(__('Labels'), __('Labels'));
        return $this;
    }
    ...
    protected function _getAclResource()
    {
        ...
        switch ($action) {
            case 'index':
                $aclResource = 'Infomodus_Upslabel::items';
                break;
            case 'save':
                $aclResource = 'Infomodus_Upslabel::create';
                break;
            case 'delete':
                $aclResource = 'Infomodus_Upslabel::delete';
                break;
            default:
